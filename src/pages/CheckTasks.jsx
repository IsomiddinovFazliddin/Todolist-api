...
function CheckTasks({ plans, delPlans, setModal, setEditId, getObj, toggleStatus }) {
  const completedTasks = plans?.filter((item) => item.status === "Completed");
            ...
            >
              <div className="">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  />
                  <h4 className="text-[#212529] font-medium text-[16px] line-through text-gray-400">
                    {item.title}
                  </h4>
                </div>
                <h5 className="pl-7 text-gray-400 text-[13px] line-through">
                  {item.description}
                </h5>
              </div>
              <div>
